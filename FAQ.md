...
Приведенные БПЛА самолетного типа имеют размах крыльев от 2 метров и используют либо двигатель внутреннего сгорания, либо реактивный двигатель. __Представляется, что такие БПЛА должны быть хорошо видимы с помощью тепловизоров и слышимы станциями звукового мониторинга.__
...
- определение текущих координат целей, направления и скорости их полета, завязка трассы
- выделение наиболее важных и опасных целей с точки зрения их возможности поражения прикрываемых объектов
- в режиме сопровождения передача целеуказания на средства поражения
...
Звуковой мониторинг работает примерно также, как и радиомониторинг. Только вместе радиосигнала принимаются звуковые сигналы. В отличие от радиосигнала звук распространяется более менее равномерно во всех направлениях. 
С учетом того, что известные БПЛА используют двигатели внутренного сгорания или реактивные двигатели пренебрегать звуковым мониторингом не стоит.  
...
- БПЛА, летящий высоко в небе, может быть не услышан микрофонами на Земле

_Необходимо уточнить вопрос на каком примерно расстоянии слышат звук определенной мощности направленные микрофоны_
...
Предположим БПЛА AQ 400 Scythe летит со скорость 40 м/c. Система обнаруживает БПЛА на расстоянии 2000 м. БПЛА долетит до системы обнаружения за 50 секунд.

## Как могла бы выглядеть система обнаружения и прерывания полета БПЛА?
